  ...
  accountsWithHoldings.forEach((account, idx) => {
    try {
      ...
      if (hasOriginalAllocation) {
        ...
        // Minimal table: Fund Name, Capital, Valuation (when no original allocation)
        tableHeadersHTML = '<tr><th>Fund Name</th><th class="numeric">Capital</th><th class="numeric">Valuation</th></tr>';
        totalRowColspan = '1';
        ...
        holdingsWithData.forEach(h => {
          try {
            ...
            holdingsRows += '<tr><td>' + (h?.fundName || 'N/A') + '</td><td class="numeric">-</td><td class="numeric">' + formatCurrency(fundValuation) + '</td></tr>';
          } catch (e) {
            console.error('[Holdings Row Error]:', h, e);
    ...
    <head>
      ...
      <style>
        * {
        ...
        .portfolio-container-no-allocation {
