    ...
    try {
      ...
      holdingsWithData.forEach(h => {
        try {
          ...
          const originalAlloc = (originalAllocValue && !isNaN(originalAllocValue)) ? originalAllocValue : null;
          ...
          const origAllocStr = (originalAlloc !== null && !isNaN(originalAlloc)) ? parseFloat(originalAlloc).toFixed(2) : '-';
          const allocStr = (!isNaN(allocation) && allocation !== null) ? parseFloat(allocation).toFixed(2) : '0.00';
          const fundPnLStr = (!isNaN(fundPnL) && fundPnL !== null) ? parseFloat(fundPnL).toFixed(2) : '0.00';

          holdingsRows += '<tr><td>' + (h?.fundName || 'N/A') + '</td><td class="numeric">' + (h?.currency || '-') + '</td><td class="numeric">' + origAllocStr + '%</td><td class="numeric">' + allocStr + '%</td><td class="numeric">' + formatCurrency(fundCapital) + '</td><td class="numeric">' + formatCurrency(fundValuation) + '</td><td class="numeric ' + fundPnLClass + '">' + fundPnLStr + '%</td><td class="numeric ' + fundPnLClass + '">' + formatCurrency(fundValuation - fundCapital) + '</td></tr>';
        } catch (e) {
      ...
      const pAndLPercentStr = (pAndL.pAndLPercent !== null && !isNaN(pAndL.pAndLPercent)) ? parseFloat(pAndL.pAndLPercent).toFixed(2) : '0.00';
      const sectionHTML = separator + '<div class="portfolio-section"><div class="portfolio-container"><div class="portfolio-sidebar"><div class="portfolio-name">' + (account.name || 'Portfolio') + '</div><div class="sidebar-item"><div class="sidebar-label">Policyowner</div><div class="sidebar-value">' + (account.policyholderName || '-') + '</div></div><div class="sidebar-item"><div class="sidebar-label">P/N</div><div class="sidebar-value">' + (account.policyNumber || '-') + '</div></div><div class="sidebar-item"><div class="sidebar-label">Start date</div><div class="sidebar-value">' + inceptionDate + '</div></div><div class="sidebar-item"><div class="sidebar-label">Capital Invested</div><div class="sidebar-value">' + formatCurrency(initialCapital) + '</div></div><div class="sidebar-item"><div class="sidebar-label">Months in</div><div class="sidebar-value">' + months + '</div></div><div class="sidebar-item"><div class="sidebar-label">CAGR</div><div class="sidebar-value">' + cagrValue + '%</div></div><div class="sidebar-item"><div class="sidebar-label">Account valuation</div><div class="sidebar-value">' + formatCurrency(currentValuation) + '</div></div><div class="sidebar-item"><div class="sidebar-label">P&L</div><div class="sidebar-value ' + pAndLClass + '">' + formatPercent(pAndL.pAndLPercent) + '</div></div></div><div class="portfolio-content"><table class="holdings-table"><thead><tr><th>Fund Name</th><th class="numeric">CCY</th><th class="numeric">Alloc %</th><th class="numeric">Weight %</th><th class="numeric">Capital</th><th class="numeric">Valuation</th><th class="numeric">P&L %</th><th class="numeric">P&L Amt</th></tr></thead><tbody>' + holdingsRows + '<tr class="total-row"><td colspan="4">TOTAL</td><td class="numeric">' + formatCurrency(initialCapital) + '</td><td class="numeric">' + formatCurrency(currentValuation) + '</td><td class="numeric ' + pAndLClass + '">' + pAndLPercentStr + '%</td><td class="numeric ' + pAndLClass + '">' + formatCurrency(pAndL.pAndLAmount) + '</td></tr></tbody></table></div></div></div>';
