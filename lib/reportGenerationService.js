  ...
  const html = `
    ...
    <body>
      ...
      ${accountMetrics.map((metric, idx) => {
        ...
        const hasAllOriginalAllocation = holdingsWithAllocation.length > 0 && holdingsWithAllocation.every(h => h.originalAllocation !== null && h.originalAllocation !== undefined && h.originalAllocation !== '');
