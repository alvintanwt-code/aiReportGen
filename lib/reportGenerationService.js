                ...
                <div class="portfolio-container">
                  ...
                  <div class="portfolio-sidebar">
                    ...
                    <div class="sidebar-item">
                      ...
                      <div class="sidebar-value">\${formatDate(perf?.inceptionDate) || '-'}</div>
                    </div>
                    ...
                    <div class="sidebar-item">
                      ...
                      <div class="sidebar-value">\${cagr ? cagr.toFixed(2) : '-'}%</div>
                    </div>
                    ...
                    <div class="sidebar-item">
                      ...
                      <div class="sidebar-value \${pAndL.pAndLAmount >= 0 ? 'positive' : 'negative'}">
                          ...
                          try {
                            ...
                            return \`
                              <tr>
                                ...
                                <td class="numeric \${fundPnL >= 0 ? 'positive' : 'negative'}">\${fundPnL.toFixed(2)}%</td>
                                <td class="numeric \${fundPnL >= 0 ? 'positive' : 'negative'}">\${formatCurrency(fundValuation - fundCapital)}</td>
                              </tr>
                            \`;
                          } catch (e) {
                            console.error('[Holdings Row Error]:', h, e);
                            return '<tr><td colspan="8">Error rendering holding</td></tr>';
                          }
                        }).join('')}
                        <tr class="total-row">
                          ...
                          <td class="numeric \${pAndL.pAndLAmount >= 0 ? 'positive' : 'negative'}">\${pAndL.pAndLPercent.toFixed(2)}%</td>
                          <td class="numeric \${pAndL.pAndLAmount >= 0 ? 'positive' : 'negative'}">\${formatCurrency(pAndL.pAndLAmount)}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
