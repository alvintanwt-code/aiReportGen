    ...
    try {
      ...
      holdingsWithData.forEach(h => {
        try {
          ...
          holdingsRows += '<tr><td>' + (h?.fundName || 'N/A') + '</td><td class="numeric">' + (h?.currency || '-') + '</td><td class="numeric">' + (isNaN(originalAlloc) ? '-' : originalAlloc.toFixed(2)) + '%</td><td class="numeric">' + (isNaN(allocation) ? '0.00' : allocation.toFixed(2)) + '%</td><td class="numeric">' + formatCurrency(fundCapital) + '</td><td class="numeric">' + formatCurrency(fundValuation) + '</td><td class="numeric ' + fundPnLClass + '">' + fundPnL.toFixed(2) + '%</td><td class="numeric ' + fundPnLClass + '">' + formatCurrency(fundValuation - fundCapital) + '</td></tr>';
        } catch (e) {
